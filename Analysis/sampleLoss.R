...
incident_row_both<-c('', '', '', paste0(incident_row16S, ifelse(incident_row16S!=incident_row16Snodups, paste0(' (', incident_row16Snodups, ')'), '')))
...
colnames(sample_table2)<-c('Birth', '  3 mos ', 'First tooth', '   12 mos', '   24 mos ', '  36 mos*', '  48 mos ', '  60 mos ', '  Total*')
rownames(sample_table2)<-c('Incident cases/controls (n)',  'Case/control samples \n with 16S data (m_16S)', 'Case/control samples \n with WGS data (m_WGS)')
