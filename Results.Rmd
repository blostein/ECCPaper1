...
```
# Notes from meeting with kelly /To Dos

## Prevacation 
  x write master script to process whole genome data 
  x put code on github 
      - all except analysis and results.rmd done 
  - do code run with deesha 
       - Make sure that paths are all set for transfer 
       x def have to change paths in run wgs (make wgs and then make sure it points to the right place 
