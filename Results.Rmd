...
t3=t3 %>% mutate(label=case_when(Taxa %in% taxa_of_interest & padj<0.05 ~ Taxa, 
                              -log10(pvalue)>10 ~ Taxa, 
                              SampleType=='saliva' & -log10(pvalue)>5 ~ Taxa,
                              TRUE ~ ''))
...
taxa_volc=t3%>%
  ...
  ggplot(aes(x=log2FoldChange, y=-log10(pvalue),
    ...
    geom_point()+
    geom_text_repel(max.overlaps = 500, , fontface = "italic")+
